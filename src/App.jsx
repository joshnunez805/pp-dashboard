...
const MASTER = [
  // Relay Modules
  {id:"rtb8",      pn:"PP-RTB8@V1",           desc:"RTB-8 Relay Module",          cat:"Relay Modules",   qty:14,  onOrder:0,   inBuild:480, eta:"Wk Mar 24", p64:12,p128:24, note:"IN BUILD (Megatone+in-house)"},
  ...
  {id:"rab16",     pn:"PP-RAB16@V1",           desc:"RAB-16 Relay Module",         cat:"Relay Modules",   qty:132, onOrder:0,   inBuild:0,   eta:"—",          p64:2, p128:0,  note:""},
  // Motherboards
  {id:"prmb64",    pn:"PP-PRMB64@V1",          desc:"PRMB64 Motherboard",          cat:"Motherboards",    qty:46,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:0,  note:""},
  {id:"prmb128",   pn:"PP-PRMB128@V1",         desc:"PRMB128 Motherboard",         cat:"Motherboards",    qty:0,   onOrder:0,   inBuild:0,   eta:"—",          p64:0, p128:1,  note:""},
  // Sub-Assemblies
  {id:"fp",        pn:"PP-FP@V1",              desc:"Front Panel Assembly",        cat:"Sub-Assemblies",  qty:0,   onOrder:100, inBuild:0,   eta:"03/18",      p64:1, p128:1,  note:"100 coming from Vin"},
  {id:"eth",       pn:"PP-ETH-1U@V1",          desc:"1U Ethernet Module",          cat:"Sub-Assemblies",  qty:24,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:"IN BUILD"},
  {id:"usb",       pn:"PP-USB-1U@V1",          desc:"1U USB Module",               cat:"Sub-Assemblies",  qty:39,  onOrder:0,   inBuild:0,   eta:"03/24",      p64:1, p128:1,  note:""},
  {id:"reg12v",    pn:"PP-12VREG@V1",          desc:"12V Regulator",               cat:"Sub-Assemblies",  qty:143, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"reg35v",    pn:"PP-3/5VREG@V1",         desc:"3/5V Regulator",              cat:"Sub-Assemblies",  qty:100, onOrder:0,   inBuild:0,   eta:"—",          p64:2, p128:2,  note:""},
  {id:"ovp",       pn:"PP-OVP@V1",             desc:"Overvolt Protection Module",  cat:"Sub-Assemblies",  qty:122, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"fpcbl64",   pn:"PP-FPCBL-64R@V1",       desc:"PP64R FP Cable Assembly",     cat:"Sub-Assemblies",  qty:42,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:0,  note:""},
  {id:"fpcbl128",  pn:"PP-FPCBL-128R@V1",      desc:"PP128R FP Cable Assembly",    cat:"Sub-Assemblies",  qty:30,  onOrder:0,   inBuild:0,   eta:"—",          p64:0, p128:1,  note:""},
  // Chassis
  {id:"chas1utop", pn:"CHAS-PP-1U-TOP@V1",     desc:"PP 1U Chassis Top",           cat:"Chassis",         qty:0,   onOrder:130, inBuild:0,   eta:"Mar 10",     p64:1, p128:1,  note:"150 actually - count when they come in"},
  {id:"chas64bot", pn:"CHAS-PP-64R-BOT@V1",    desc:"PP64R Chassis Bottom",        cat:"Chassis",         qty:17,  onOrder:70,  inBuild:0,   eta:"Mar 24",     p64:1, p128:0,  note:""},
  {id:"chas128bot",pn:"CHAS-PP-128R-BOT@V1",   desc:"PP128R Chassis Bottom",       cat:"Chassis",         qty:27,  onOrder:0,   inBuild:0,   eta:"—",          p64:0, p128:1,  note:""},
  {id:"fapnl",     pn:"FAPNL-PP-1U@V1",        desc:"1U Face Panel",               cat:"Chassis",         qty:140, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  // Power & Compute
  {id:"pwr",       pn:"PWR-100W-USBC",          desc:"100W USB-C Power Supply",     cat:"Power & Compute", qty:16,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:"Order Amazon"},
  {id:"sbc",       pn:"SBC-RPI-CM4101016",      desc:"RPi CM4 SBC",                 cat:"Power & Compute", qty:75,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:"Bryce approving order"},
  // Hardware
  {id:"screw",     pn:"SCWJAK-4U40-4H8.1",     desc:"4-40 4.8mm Jack Screw",       cat:"Hardware",        qty:170, onOrder:0,   inBuild:0,   eta:"—",          p64:8, p128:8,  note:""},
  {id:"btry",      pn:"BTRY-CR1220",            desc:"CR1220 Battery",              cat:"Hardware",        qty:204, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"neop",      pn:"PP-NEOP-T3/32-1W",       desc:"Neoprene Strip (ft)",         cat:"Hardware",        qty:200, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"lbkt",      pn:"PP-L-440-BKT",           desc:"4-40 Short-L Bracket",        cat:"Hardware",        qty:90,  onOrder:0,   inBuild:0,   eta:"03/10",      p64:1, p128:1,  note:""},
  {id:"plugeth",   pn:"PP-PLUG-ETH",            desc:"Eth Dust Plug",               cat:"Hardware",        qty:240, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"btryhldr",  pn:"PP-BTRY-HLDR",           desc:"Battery Holder",              cat:"Hardware",        qty:285, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"hdr2p",     pn:"PP-HDR-2P-PWR",          desc:"2P HDR R/A USB Power",        cat:"Hardware",        qty:110, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"h2b4p",     pn:"H2B-4P-RA.1",            desc:"4P RA HDR-to-BRD Connector",  cat:"Hardware",        qty:290, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"jcab10p",   pn:"JCAB-10P2-150ML.1",      desc:"10P2 150mm Jumper Cable",     cat:"Hardware",        qty:70,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  {id:"jcab4p",    pn:"JCAB-4P-4L25.1",         desc:"4P 4.25in Jumper Cable",      cat:"Hardware",        qty:105, onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  ...
  // Spacers
  {id:"spcr64rtb", pn:"PP-SPCR-64/128R-RTB@V1", desc:"64/128R RTB Spacer",          cat:"Hardware",        qty:148, onOrder:0,   inBuild:0,   eta:"—",          p64:2, p128:2,  note:""},
  {id:"spcr64rab", pn:"PP-SPCR-64R-RAB/RIO@V1", desc:"64R RAB/RIO Spacer",          cat:"Hardware",        qty:80,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:0,  note:""},
  {id:"spcr128riol",pn:"PP-SPCR-128R-RIO-L@V1", desc:"128R RIO Spacer Left",        cat:"Hardware",        qty:40,  onOrder:0,   inBuild:0,   eta:"—",          p64:0, p128:1,  note:""},
  {id:"spcr128rior",pn:"PP-SPCR-128R-RIO-R@V1", desc:"128R RIO Spacer Right",       cat:"Hardware",        qty:70,  onOrder:0,   inBuild:0,   eta:"—",          p64:0, p128:1,  note:""},
  // PCBs
  {id:"pcbfpjak",  pn:"PCB-PP-FP-JAK@V1",       desc:"PCB FP 1/4in Jack Spacer",   cat:"PCBs",            qty:284, onOrder:0,   inBuild:0,   eta:"—",          p64:2, p128:2,  note:""},
  {id:"pcbins",    pn:"PCB-PP-PRMB-INS@V1",      desc:"PRMB Insulator PCB",         cat:"PCBs",            qty:90,  onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:""},
  // Shipping
  {id:"shipkit",   pn:"PP-SHIPKIT-1U@V1",        desc:"Ship-Kit 1U",                cat:"Shipping",        qty:0,   onOrder:0,   inBuild:0,   eta:"—",          p64:1, p128:1,  note:"TBD"},
];
